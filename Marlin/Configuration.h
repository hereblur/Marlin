...
#define STRING_CONFIG_H_AUTHOR "(Supasak, for tevo tornado)"  // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Muffin"
...
#define DEFAULT_bedKp 84.21
#define DEFAULT_bedKi 14.90
#define DEFAULT_bedKd 119.00
